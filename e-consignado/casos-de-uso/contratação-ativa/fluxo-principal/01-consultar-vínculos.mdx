...
HML: https://originator-integration.apidev.wincred.digital
...
```bash
curl -X POST "https://originator-integration.apidev.wincred.digital/api/v1/e-consignado/vinculos" \
