...
```bash
curl -X POST "https://originator-integration.apidev.wincred.digital/api/v1/e-consignado/contratos" \
...
<ParamField body="pessoa" type="object" required>
  ...
  <Expandable title="Propriedades">
    ...
    <ParamField body="estadoCivil" type="string" required>
      ...
      **Valores possíveis:** `SOLTEIRO`, `CASADO`, `DIVORCIADO`, `VIUVO`, `SEPARADO`, `UNIAO_ESTAVEL`, `NAO_INFORMADO`, `SEPARADO_JUDICIALMENTE`, `UNIAO_ESTAVEL`, `OUTROS`
    </ParamField>
