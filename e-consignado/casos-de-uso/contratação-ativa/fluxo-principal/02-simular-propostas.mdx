...
```bash
curl -X POST "https://api.wincred.digital/api/v1/e-consignado/simular" \
  ...
  -d '{
    ...
    "empresa": { // Dados que retornam da dataprev
        "tipoInscricao": 0,
        "numeroInscricao": "",
        "matricula": "", // matricula do funcionário na empresa
    },
  }'
```
...
<ParamField path="empresa" type="object" required>
  ...
  <Expandable title="Propriedades">
    <ParamField path="tipoInscricao" type="int" required>
      Tipo de inscrição da empresa (0 - CPF, 1 - CNPJ)
    </ParamField>
